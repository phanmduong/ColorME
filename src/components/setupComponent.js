        ...
        return (
            <Container>
                ...
                <Tabs tabBarUnderlineStyle={{backgroundColor:color.main}}>
                    ...
                    <Tab heading={<TabHeading><Text style={part.titleSmallDarkBold}>Thông tin</Text></TabHeading>}>
                        <Information />
                    </Tab>
                    <Tab heading={<TabHeading><Text style={part.titleSmallDarkBold}>Dự án</Text></TabHeading>}>
                        <Project/>
                    </Tab>
                    <Tab heading={<TabHeading><Text style={part.titleSmallDarkBold}>Tiến dộ</Text></TabHeading>}>
                        <Process/>
                    </Tab>
                </Tabs>
            </Container>
    ...
    render() {
        return (
            <Container>
                    ...
                    <Text style={part.describeDark}></Text>
                    </Body>
